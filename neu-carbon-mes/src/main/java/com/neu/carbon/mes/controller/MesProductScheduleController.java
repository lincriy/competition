...
public class MesProductScheduleController extends BaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('mes:schedule:export')")
    ...
    {
        return AjaxResult.success(mesProductScheduleService.selectMesProductScheduleById(id));
    }
    ...
    @PreAuthorize("@ss.hasPermi('mes:schedule:add')")
    ...
    @PreAuthorize("@ss.hasPermi('mes:schedule:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('mes:schedule:remove')")
